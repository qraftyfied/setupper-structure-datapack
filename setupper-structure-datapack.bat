...
echo {"pack":{"pack_format":10,"description":{"text":"%description%","color":"aqua","hoverEvent":{"action":"show_text","value":"%description%"}}}} > "%foldername%\pack.mcmeta"
